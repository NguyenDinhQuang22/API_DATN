...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $product->total_room = $request->total_room;
            $product->preferred_gender = $request->preferred_gender;
            $product->self_governance = $request->self_governance;
            $product->host = $request->host;
